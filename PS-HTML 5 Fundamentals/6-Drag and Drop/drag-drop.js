//"Abstracts out a lot of the complexities for all the boiler plate code 
//that's needed to handle events, cancel default behavior, set class names,
//and remove classes [for HTML 5 drag and drop]"
...
var dragDrop = (function () {
	var
        ...
        _isDnDTypesSupported = true; //For IE support
	...
	var
        ...
        dragStart = function (e) {
        	...
        	try {
        		e.dataTransfer.setData('text/plain', ''); //For Firefox support
        	} catch (e) {
